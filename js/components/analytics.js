...
class AnalyticsComponent {
    ...
    calculateOverviewMetrics() {
        ...
        const currentMetrics = this.calculateMetrics(orders);
    ...
    calculatePlatformComparison() {
        ...
        const cdekOrders = orders.filter(o => o.platform === 'cdek');
        const megamarketOrders = orders.filter(o => o.platform === 'megamarket');
        
        const cdekValue = this.calculateMetricValue(cdekOrders, currentMetric);
        const megamarketValue = this.calculateMetricValue(megamarketOrders, currentMetric);
    ...
    calculateMetricValue(orders, metric) {
        switch (metric) {
            ...
            case 'delivery_time':
                // Mock данные для времени доставки
    ...
    getPreviousPeriodOrders() {
        // Mock метод - в реальном приложении здесь будет запрос к API
        return [];
    }
