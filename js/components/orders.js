...
class OrdersComponent {
        ...
        container.innerHTML = `
            <div class="orders-toolbar">
                <div class="toolbar-left">
                    <div class="search-box">
                        ...
                        <input 
                            ...
                            oninput="app.ordersComponent.setSearchFilter(this.value)"
                        >
                    </div>
                ...
                <div class="toolbar-right">
                    ...
                    <button class="btn btn-secondary btn-sm" onclick="app.ordersComponent.refreshOrders()">
    ...
    quickAction(platform, orderId) {
        // Mock метод для быстрых действий
        const actions = {
            cdek: ['Обновить статус', 'Скачать накладную', 'Связаться с клиентом'],
            megamarket: ['Подтвердить заказ', 'Упаковать', 'Отменить заказ']
        };
